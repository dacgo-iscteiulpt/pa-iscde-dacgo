...
//		ServiceReference<OutlineViewServices> outlineReference = context.getServiceReference(OutlineViewServices.class);
//		OutlineViewServices outlineServ = context.getService(outlineReference );
		...
		//new code
//		CodeGeneratorListener codeGenListener = new CodeGeneratorListener();
//		outlineServ.addListener(codeGenListener);
	}
